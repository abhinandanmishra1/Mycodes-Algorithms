...
int main()
{
    ...
    string search_text = "text"; //string to be searched
    int l = search_text.length();

    string text = "This is a text in which text is to be searched and index will be printed where text is present."; //text for searching
    int len = text.length();
